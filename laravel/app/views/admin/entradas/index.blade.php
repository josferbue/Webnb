	...
	<div class="page-header">
		<h3>
			...
			<div class="pull-right">
				<a href="{{{ URL::to('admin/entradas/create') }}}" class="btn btn-small btn-info iframe"><span class="glyphicon glyphicon-plus-sign"></span> Nueva entrada</a>
			</div>
		</h3>
	</div>
	...
	<table id="entradas" class="table table-striped table-hover">
		<thead>
			<tr>
				...
				<th class="col-md-4">{{{ Lang::get('table.actions') }}}</th>
			</tr>
		</thead>
		<tbody>
		</tbody>
