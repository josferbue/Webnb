...
class Collection implements ArrayAccess, Countable, IteratorAggregate
{
    ...
    {
        return new static(ArrayHelpers::fetch($this->items, $key));
    }
    ...
    public function first(Closure $callback = null, $default = null)
    {
        ...
        {
            return ArrayHelpers::first($this->items, $callback, $default);
        }
    }
    ...
    {
        return new static(ArrayHelpers::flatten($this->items));
    }
    ...
    public function get($key, $default = null)
    {
        ...
        return ArrayHelpers::value($default);
    }
    ...
    public function groupBy($groupBy)
    {
        ...
        {
            $key = is_callable($groupBy) ? $groupBy($value, $key) : ArrayHelpers::data_get($value, $groupBy);
    ...
    */
    ...
    {
        return ArrayHelpers::pluck($this->items, $value, $key);
    }
    ...
    protected function valueRetriever($value)
    {
        ...
        {
            return is_object($item) ? $item->{$value} : ArrayHelpers::get($item, $value);
        };
    }
